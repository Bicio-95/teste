...
public class MarsRover {
	 private String inst_set;
	    ...
	    public static void main(String... a){
	        ...
	        String dir;
	        System.out.println("Enter the direction the rover is Headed // Insira a direção em que o rover está Dirigido: ");
	        dir=in.nextLine();

	        System.out.println("Enter the Initial XLocation: // Insira o XLocation inicial: ");
	        x=in.nextInt();
	        in.nextLine();

	        System.out.println("Enter the Initial YLocation: Insira o YLocation inicial: ");
	        y=in.nextInt();
	        in.nextLine();

	        System.out.println("Enter the Instructions\t: // Insira as Instruções");
	        instSet=in.nextLine();
